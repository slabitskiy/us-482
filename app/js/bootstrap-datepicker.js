   ...
   // end
	...
	Datepicker.prototype = {
		...
		fill: function(){
			...
			while (prevMonth.valueOf() < nextMonth){
				...
				html.push('<td class="'+clsName.join(' ')+'"' + (tooltip ? ' title="'+tooltip+'"' : '') + '><b class="span">'+prevMonth.getUTCDate() +'</b>'+'</td>');
				tooltip = null;
		...
		click: function(e){
			e.preventDefault();
			e.stopPropagation();
			var target = $(e.target).closest('span, td, th,.span'),
				year, month, day;
			if (target.length === 1){
	...
	var DPGlobal = {
		...
		headTemplateDays: '<thead>'+
							'<tr>'+
								'<th class="prev" colspan="1">&#171;</th>'+
								'<th colspan="1"></th>'+
								'<th colspan="3" class="datepicker-switch"><span> </span>'+
								'</th>'+
								'<th colspan="1"></th>'+
								'<th class="next" colspan="1">&#187;</th>'+
							'</tr>'+
						'</thead>',
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev" colspan="1">&#171;</th>'+
								'<th colspan="5" class="datepicker-switch"><span> </span>'+
								'</th>'+
								'<th class="next" colspan="1">&#187;</th>'+
							'</tr>'+
						'</thead>',
